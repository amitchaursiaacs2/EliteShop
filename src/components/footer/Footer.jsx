                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-md-3 part1">
                                ...
                                <p>
                                    <WifiCalling3OutlinedIcon /><strong>Call Us:</strong>
                                    (+91) - 88581 13691
                                </p>
                                <p>
                                ...
                                <p>
                                    <AccessTimeOutlinedIcon /><strong>Hours:</strong>
                                    10:00 - 18:00, Mon - Sat
                                </p>
                            </div>
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="d-flex">
                                    <Link to="">
                                        <img src="/assets/img/goolePlay.png" alt="No_img" width={150} />
                                    </Link>
                                    <Link to="">
                                        <img src="/assets/img/AppStore.png" alt="No_img" className='mx-2' width={150} />
                                    </Link>
                                </div>
                                <br />

                                <p>Secured Payment Gateways</p>
                                <img src="/assets/img/payGatway.webp" alt="No_img" width={300} />
                            </div>
                        </div>
                        ...
                        <div className="row lastStrp">
                            <div className="col-md-3 Copyright">
                                Copyright © {new Date().getFullYear()} All Rights Reserved | Elite Shope
                            </div>
