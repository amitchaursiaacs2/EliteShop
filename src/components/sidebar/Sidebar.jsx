                ...
                <div className="card border-0 shadow">
                    ...
                    <div className="filters">
                        ...
                        <ul className='p-0 mb-0'>
                            ...
                            <li><Checkbox {...label} color="success" />White(56)</li>
                            <li><Checkbox {...label} color="success" />Black(56)</li>
                            <li><Checkbox {...label} color="success" />Maroon(56)</li>
                            <li><Checkbox {...label} color="success" />Blue(56)</li>
                            <li><Checkbox {...label} color="success" />Voilet(56)</li>
                            <li><Checkbox {...label} color="success" />Purpul(56)</li>
                            <li><Checkbox {...label} color="success" />Aqualite(56)</li>
                            <li><Checkbox {...label} color="success" />Red(56)</li>
                            <li><Checkbox {...label} color="success" />Green(56)</li>
                            <li><Checkbox {...label} color="success" />White(56)</li>
                            <li><Checkbox {...label} color="success" />Black(56)</li>
                    ...
                    <div className="filters">
                        ...
                        <ul className='p-0 mb-0'>
                            <li><Checkbox {...label} color="success" />New(68)</li>
                            <li><Checkbox {...label} color="success" />Used(50)</li>
                            <li><Checkbox {...label} color="success" />Refurbishe(509)</li>
                            <li><Checkbox {...label} color="success" />New(68)</li>
                            <li><Checkbox {...label} color="success" />Used(50)</li>
                            <li><Checkbox {...label} color="success" />Refurbishe(509)</li>
                            <li><Checkbox {...label} color="success" />New(68)</li>
